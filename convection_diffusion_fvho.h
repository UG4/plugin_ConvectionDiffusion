...
//	exports
	m_exValue->	   template set_fct<T,refDim>(id, this, &T::template ex_value_fvho<TElem, TGeomProvider>);
	m_exGrad->template set_fct<T,refDim>(id, this, &T::template ex_grad_fvho<TElem, TGeomProvider>);
}
