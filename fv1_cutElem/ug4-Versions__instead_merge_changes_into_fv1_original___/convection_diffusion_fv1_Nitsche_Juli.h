...
class ConvectionDiffusionFV1 : public ConvectionDiffusionBase<TDomain>
{
	...
	///	assembles the local stiffness matrix using a finite volume scheme
		...
		template <typename TElem, typename TFVGeom>
		void add_jac_A_elem_local(TFVGeom& geo, LocalMatrix& J, const LocalVector& u, GridObject* elem, const MathVector<dim> vCornerCoords[], const bool bElementIsCut);
	...
	///	assembles the stiffness part of the local defect
		template <typename TElem, typename TFVGeom>
 		void add_def_A_elem_local(TFVGeom& geo, LocalVector& d, const LocalVector& u, GridObject* elem, const MathVector<dim> vCornerCoords[], const bool bElementIsCut);
